 ...
 * @author Our
 */
public class modelDialogsetModel {
    ...
    public void pilihdataset() {
        try {
            ...
            String query = "SELECT tahun_ajaran, COUNT(nis) as jumlah_data FROM Model_Siswa GROUP BY tahun_ajaran";
            ...
            System.out.println("Model.modelDialogset.pilihdataset()");
            e.printStackTrace();
        }
    }
    ...
    public void hapusTahunAjaran(String tahunAjaran) {
        try {
            ...
            String query = "DELETE FROM Model_Siswa WHERE tahun_ajaran = '"+tahunAjaran+"'";
