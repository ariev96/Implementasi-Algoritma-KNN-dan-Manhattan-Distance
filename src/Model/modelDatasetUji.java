...
public class modelDatasetUji {
    ...
    public void SimpanTahunAjaran() throws SQLException{
        ...
        try{
            ...
            System.out.println("Model.modelDatasetUji.SimpanTahunAjaran() \n" +e);
        }
    }
    ...
    public void SimpanDataNilai(){
        try {
            connection = dbkonek.konek1();
            query = "INSERT INTO Uji_Siswa(Tahun_Ajaran, NIS, NAMA, JenisKelamin, "
                    + "Jurusan, Mean_SMS1, Mean_SMS2, Mean_SMS3, Mean_SMS4, Mean_SMS5, Mean_SMS6, "
                    + "MTK1, BINDO1, BING1, Peminatan1, MTK2, BINDO2, BING2, Peminatan2, "
                    + "Keterangan) "
                    + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
            ...
            System.out.println("Model.modelDatasetUji.SimpanDataNilai()\n" +e);
        }
    }
    ...
    public int PilihTotalData(){
        ...
        try {
            connection = dbkonek.konek1();
            query = "select count(*) as total_data from Uji_Siswa";
            statement = connection.createStatement();
            rs = statement.executeQuery(query);
            while (rs.next()){
    ...
    public boolean cekTA() throws SQLException{
        ...
        try {
            ...
            System.out.println("Model.modelDatasetUji.cekTA()\n" +e);
        }
        return cekTahun;
    }
